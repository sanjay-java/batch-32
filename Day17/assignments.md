#### Given a Student Object with FirstName, LastName and GPA as attributes,  Create a Hashmap of 8 students , with Key as the first name and value as Student object. Print the HashMap.
